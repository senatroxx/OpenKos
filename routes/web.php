...
Route::middleware(['auth', 'verified', 'permission:dashboard.view'])->group(function () {
    ...
    Route::prefix('properties')->name('properties.')->group(function () {
        ...
        Route::scopeBindings()->group(function () {
            Route::prefix('{property}')->group(function () {
                ...
                Route::get('inspections', [InspectionController::class, 'propertyIndex'])->name('workspace.inspections')->middleware('permission:inspections.view');
                Route::post('inspections', [InspectionController::class, 'storeForProperty'])->name('inspections.store')->middleware('permission:inspections.create');
    ...
    Route::prefix('leases')->name('leases.')->group(function () {
        ...
        Route::prefix('{lease}')->whereNumber('lease')->group(function () {
            ...
            Route::get('inspections', [InspectionController::class, 'leaseIndex'])->name('workspace.inspections')->middleware('permission:inspections.view');
            Route::post('inspections', [InspectionController::class, 'storeForLease'])->name('inspections.store')->middleware('permission:inspections.create');

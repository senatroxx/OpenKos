...
export const countryCodes: CountryCode[] = [
    ...
    { iso2: 'KN', name: 'Saint Kitts & Nevis', dialCode: '+1' },
    { iso2: 'LC', name: 'Saint Lucia', dialCode: '+1' },
    { iso2: 'VC', name: 'Saint Vincent & Grenadines', dialCode: '+1' },
...
export function parseE164(value?: string | null): CountryCode & { number: string } {
    ...
    for (const c of sorted) {
        const prefix = c.dialCode.slice(1);

        if (digits.startsWith(prefix)) {
            return { ...c, number: digits.slice(prefix.length) };
        }
    }
    ...
    const indonesia = countryCodes.find((c) => c.iso2 === 'ID')!;

    return { ...indonesia, number: digits };
}
